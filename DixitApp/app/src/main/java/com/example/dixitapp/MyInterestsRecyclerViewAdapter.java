...
import com.example.dixitapp.InterestsFragment.OnListFragmentInteractionListener;
...
public class MyInterestsRecyclerViewAdapter extends RecyclerView.Adapter<MyInterestsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyInterestsRecyclerViewAdapter(List<Interest> items, OnListFragmentInteractionListener listener, Context context) {
        mValues = items;
        mListener = listener;
        mContext = context;
    }
